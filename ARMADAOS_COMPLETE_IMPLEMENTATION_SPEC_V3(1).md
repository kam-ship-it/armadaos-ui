...
### 9.1. Canonical Logo Files

**Logo Description:** Tri-prism shield (2 variants: 2D flat + 3D with depth)

**2D Logo (Flat Shield) - RECOMMENDED FOR UI:**
- **White** (for dark backgrounds): `/assets/armadaos-logo-2d-white-32.png`
- **Black** (for light backgrounds): `/assets/armadaos-logo-2d-black-32.png`

**3D Logo (With Depth & Shading) - FOR HERO MOMENTS:**
- **White** (for dark backgrounds): `/assets/armadaos-logo-3d-white-32.png`
- **Black** (for light backgrounds): `/assets/armadaos-logo-3d-black-32.png`

**All Sizes Available:**
- 32px (UI elements, taskbar, navigation)
- 64px (dock, small hero)
- 128px (medium hero, cards)
- 256px (large hero, splash screens)
- 512px (extra large hero)
- 1024px (marketing, print)

**File Naming Convention:**
```
armadaos-logo-[2d|3d]-[white|black]-[size].png
```

**Examples:**
- `armadaos-logo-2d-white-32.png` (2D white logo, 32px)
- `armadaos-logo-3d-black-256.png` (3D black logo, 256px)

**All logos have transparent PNG backgrounds. No black squares. No white squares.**
